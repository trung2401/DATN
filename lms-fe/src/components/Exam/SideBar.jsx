...
const Sidebar = ({
  ...
  return (
    <div className="w-[350px] h-[700px] hidden lg:flex lg:flex-col xl:flex xl:flex-col border-2 border-gray-200 rounded-2xl shadow-xl">
      <div className="w-full py-2.5 border-2 border-[#25B379] rounded-tr-2xl rounded-tl-2xl flex items-center justify-center bg-[#25B379]">
      ...
      <div className="flex gap-3 items-center justify-center py-3 rounded-bl-2xl rounded-br-2xl">
        <span className="font-bold border-2 rounded-lg border-[#25B379] px-3 py-2.5">
